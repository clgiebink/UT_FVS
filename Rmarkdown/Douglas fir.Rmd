...
#CR
plotLowess(resid_clmred~z.CR_fvs,data = glmm_df_z,ylab="Residuals",main="Climate Reduced: CR")
#plotLowess(resid_lmm1~z.CR_fvs,data = glmm_df_z,ylab="Residuals",main="LMM1")
#precip
