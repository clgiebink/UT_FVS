...
#change shapes
models_df <- models_df %>% filter(term != "(Intercept)")
...
nint3 <- plot_model(clim_nint_df, type = "pred", terms = c("z.ppt_pJunSep","z.SDI"),
                    axis.title = c("Precip","dds"), legend.title = "SDI", title = "",
                    colors = c("#CCFFCC","#006600","#003300")) +
  theme_bw()
nint4 <- plot_model(clim_nint_df, type = "pred", terms = c("z.SDI","z.n_ppt"),
                    axis.title = c("SDI","dds"), legend.title = "Precip Normal", title = "",
                    colors = c("#99CCFF","#3399FF","#003366")) +
  theme_bw()
...
```{r}
plot_model(n_df, type = "pred", terms = c("z.ppt_pJunSep","z.n_ppt"),
                    axis.title = c("Precip","dds"), legend.title = "Precip Normal", title = "") +
  theme_bw()
plot_model(n_df, type = "pred", terms = c("z.tmax_FebJul","z.n_ppt"),
                    axis.title = c("Temp","dds"), legend.title = "Precip Normal", title = "")
plot_model(n_df, type = "pred", terms = c("z.tmax_FebJul","z.n_tmp"),
                    axis.title = c("Temp","dds"), legend.title = "Temp Normal", title = "")
plot_model(n_df, type = "pred", terms = c("z.ppt_pJunSep","z.n_tmp"),
