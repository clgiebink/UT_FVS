...
```{r }
load(file = '/home/giebink/Documents/Masters/UT/UT_FVS/data/formatted/data_all_es.Rdata')
```
...
lmm_es_red <- lmer(log(dds+0.001)~
               ...
               data = glmm_es_z)
plot(effect("z.DIA_C",lmm_es_red),xlab = "DBH",main = "DBH")
plot(effect("z.CR_weib",lmm_es_red),xlab = "Crown Ratio",main = "Crown Ratio")
plot(effect("z.CCF",lmm_es_red),xlab = "CCF",main = "CCF")
plot(effect("z.SICOND",lmm_es_red),xlab = "Site Index",main = "Site Index")
plot(effect("z.SLOPE",lmm_es_red),xlab = "Slope",main = "Slope")
plot(effect("z.wateryr",lmm_es_red),xlab = "Precipitation",main = "Precipitation")
plot(effect("z.tmax_pAug",lmm_es_red),xlab = "Temperature",main = "Temperature")
```
