...
#change shapes
models_es <- models_es %>% filter(term != "(Intercept)")
...
es_mods <- ggplot(data = models_es, aes(x = term, y = estimate, shape = model)) + 
  ...
  coord_flip() +
  theme_bw() + ylab("Coefficient Estimate") + xlab("") +
  theme(plot.title = element_text(face="bold"),
...
clint <- plot_model(clim_red_es, type = "pred", terms = c("z.ppt_pJunSep","z.tmax_pAug"),
                    axis.title = c("Precip","dds"), legend.title = "Temp", title = "",
                    colors = c("#FF9999", "#CC6666", "#660000")) +
  theme_bw()
nint1 <- plot_model(clim_n_es, type = "pred", terms = c("z.ppt_pJunSep","z.n_ppt"),
                    axis.title = c("Precip","dds"), legend.title = "Precip Normal", title = "",
                    colors = c("#99CCFF","#3399FF","#003366")) +
  theme_bw()
...
nint4 <- plot_model(clim_nint_es, type = "pred", terms = c("z.ppt_pJunSep","z.BAL"),
                    axis.title = c("Precip","dds"), legend.title = "BAL", title = "",
                    colors = c("#CCFFCC","#006600","#003300")) +
  theme_bw()
