...
ggplot() + 
  ...
  geom_point(data=varmt_es_z,aes(x=LON,y=LAT),colour="red")+
...
```{r}
par(mfrow=c(2,2))
hist(varmt_es_z$RW,breaks = 50, 
     main = "Histogram of RW (mm)", xlab = "Increment")
hist(varmt_es_z$dds,breaks = 100,
     main = "Histogram of DDS (in^2)", xlab = "Increment")
hist(log(varmt_es_z$dds),breaks = 100, 
...
#Cleveland dotplot
par(mfrow=c(1,2))
dotchart(varmt_es_z$dds)
dotchart(log(varmt_es_z$dds))
```
...
```{r}
length(which(varmt_es_z$RW == 0)) #missing rings
which(is.na(varmt_es_z$RW)) 
which(varmt_es_z$dds ==0)
...
```{r}
length(unique(varmt_es_z$TRE_CN))
length(unique(varmt_es_z$PLT_CN))
```
...
growth_wateryr_plots_es <- varmt_es_z %>% 
  group_by(Year) %>%
  do(plots=ggplot(data=.) +
...
par(mfrow=c(2,2))
#detrend
ggplot(data = varmt_es_z, aes(x = DIA_C, y = RW)) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")

ggplot(data = varmt_es_z, aes(x = DIA_C, y = dds)) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")

ggplot(data = varmt_es_z, aes(x = DIA_C, y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")

#log to reduce heteroscedasticity
ggplot(data = varmt_es_z, aes(x = log(DIA_C), y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")
...
```{r}
ggplot(data = varmt_es_z, aes(x = SICOND, y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")
```
...
```{r}
ggplot(data = varmt_es_z, aes(x = SLOPE, y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")
```
...
```{r}
ggplot(data = varmt_es_z, aes(x = BAL, y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")
```
...
```{r}
ggplot(data = varmt_es_z, aes(x = PCCF, y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")
```
...
```{r}
ggplot(data = varmt_es_z, aes(x = CCF, y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")
```
...
```{r}
par(mfrow=c(1,2))
ggplot(data = varmt_es_z, aes(x = CR, y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")

ggplot(data = varmt_es_z, aes(x = CR_fvs, y = log(dds))) +
  geom_point(alpha=0.1) + geom_smooth(method = "lm")
```
...
plot_model(clim_n_es, type = "pred", terms = c("z.tmax_pAug","z.n_tmp"),
                    axis.title = c("Temp","dds"), legend.title = "Temp Normal", title = "")
```
...
```{r}
plot_model(clim_int_es, type = "pred", terms = c("z.ppt_pJunSep","z.DIA_C"), title = "")
plot_model(clim_int_es, type = "pred", terms = c("z.ppt_pJunSep","z.BAL"), title = "")
plot_model(clim_int_es, type = "pred", terms = c("z.ppt_pJunSep","z.SLOPE"), title = "")
```
...
clim_nint_es <- lmer(log(dds)~
                 ...
                 control = lmerControl(optimizer = "Nelder_Mead",optCtrl = list(maxfun = 100000)),
               data = varmt_es_z)
AIC(an_al_es,an_red_es,clim_al_es,clim_red_es,clim_n_es,clim_nint_es)
```
...
par(mfrow=c(2,2))
#dbh
plotLowess(resid_clmred~z.DIA_C,data = varmt_es_z,ylab="Residuals",main="Climate Reduced: DBH")
#plotLowess(resid_lmm1~z.DIA_C,data = varmt_es_z,ylab="Residuals",main="LMM1")
#CR
plotLowess(resid_clmred~z.CR_fvs,data = varmt_es_z,ylab="Residuals",main="Climate Reduced: CR")
#plotLowess(resid_lmm1~z.CR_fvs,data = varmt_es_z,ylab="Residuals",main="LMM1")
#precip
plotLowess(resid_clmred~z.ppt_pJunAug,data = varmt_es_z,ylab="Residuals",main="Climate Reduced: Precip") 
#plotLowess(resid_lmm1~z.ppt_pJunAug,data = varmt_es_z,ylab="Residuals",main="LMM1") 
#temp
plotLowess(resid_clmred~z.tmax_pAug,data = varmt_es_z,ylab="Residuals",main="Climate Reduced: Temp")
#plotLowess(resid_lmm1~z.tmax_pAug,data = varmt_es_z,ylab="Residuals",main="LMM1")
#CCF
plotLowess(resid_clmred~z.BAL,data = varmt_es_z,ylab="Residuals",main="Climate Reduced: CCF")
#plotLowess(resid_lmm1~z.CCF,data = varmt_es_z,ylab="Residuals",main="LMM1")
#SI
plotLowess(resid_clmred~z.SICOND,data = varmt_es_z,ylab="Residuals",main="Climate Reduced: SI")
#plotLowess(resid_lmm1~z.SICOND,data = varmt_es_z,ylab="Residuals",main="LMM1")
#Slope
plotLowess(resid_clmred~z.SLOPE,data = varmt_es_z,ylab="Residuals",main="Climate Reduced: Slope")
#plotLowess(resid_lmm1~z.SLOPE,data = varmt_es_z,ylab="Residuals",main="LMM1")
```
...
red_n_es <-  tidy(clim_n_es) %>% 
  ...
  relabel_predictors(c(z.DIA_C = "DBH",                       # relabel predictors
                       ...
                       "z.tmax_pAug:z.n_tmp" = "Temp:Temp Normal"))
red_nint_es <-  tidy(clim_nint_es) %>% 
  filter(effect == "fixed") %>%
  dplyr::select(term,estimate,std.error) %>%
...
ggsave(filename = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/images/es_mods.png",mod_es,
       height = 5, width = 8, units = "in")

#change shapes
models_es <- models_es %>% filter(term != "(Intercept)") %>% droplevels()
models_es$model <- factor(models_es$model, levels = c("Full Annual", "Reduced Annual", "Full Climate",
                                                      "Reduced Climate", "Climate Normals","Normals + Interactions"))
es_mods <- ggplot(data = models_es, aes(x = term, y = estimate, shape = model)) + 
  ...
  scale_x_discrete(limits = rev(levels(models_es$term))) +
...
ggsave(filename = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/images/es_mods.png",
...
```{r}
d <- plot(effect("z.DIA_C",clim_red_es),xlab = "DBH",main="")
c <- plot(effect("z.CR",clim_red_es),xlab = "Crown Ratio",main="")
sdi <- plot(effect("z.BAL",clim_red_es),xlab = "BAL",main="")
si <- plot(effect("z.SICOND",clim_red_es),xlab = "Site Index",main="")
sl <- plot(effect("z.SLOPE",clim_red_es),xlab = "Slope",main="")
ppt <- plot(effect("z.ppt_pJunSep",clim_n_es),xlab = "Precipitation",main="")
tmp <- plot(effect("z.tmax_pAug",clim_n_es),xlab = "Temperature",main="")
all_coef <- arrangeGrob(d,c,sdi,si,sl,ppt,tmp,nrow=3)
ggsave(filename = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/images/eff_es.png", all_coef)
```

### Interaction

```{r}
clint <- plot_model(clim_red_es, type = "pred", terms = c("z.ppt_pJunSep","z.tmax_pAug"),
                    axis.title = c("Precip","dds"), title = "b) Temp",  show.legend = F,
                    colors = c("grey72", "gray47", "gray0")) +
  theme_bw() + labs(y = expression(paste("dds (i", n^2, ")"))) +
  geom_rug(data = varmt_es_z, aes(x = z.ppt_pJunSep), inherit.aes = FALSE,
           alpha = 0.1, sides = "b")
nint1 <- plot_model(clim_n_es, type = "pred", terms = c("z.ppt_pJunSep","z.n_ppt"),
                    axis.title = c("Precip","dds"), title = "c) Precip Normal", show.legend = F,
                    colors = c("grey72", "gray47", "gray0")) +
  theme_bw() + labs(y = expression(paste("dds (i", n^2, ")"))) +
  geom_rug(data = varmt_es_z, aes(x = z.ppt_pJunSep), inherit.aes = FALSE,
           alpha = 0.1, sides = "b")
nint2 <- plot_model(clim_n_es, type = "pred", terms = c("z.ppt_pJunSep","z.n_tmp"),
                    axis.title = c("Precip","dds"), title = "d) Temp Normal",  show.legend = F,
                    colors = c("grey72", "gray47", "gray0")) +
  theme_bw() + labs(y = expression(paste("dds (i", n^2, ")"))) +
  geom_rug(data = varmt_es_z, aes(x = z.ppt_pJunSep), inherit.aes = FALSE,
           alpha = 0.1, sides = "b")
nint3 <- plot_model(clim_n_es, type = "pred", terms = c("z.tmax_pAug","z.n_tmp"),
                    axis.title = c("Temp","dds"), title = "e) Temp Normal",  show.legend = F,
                    colors = c("grey72", "gray47", "gray0")) +
  theme_bw() + labs(y = expression(paste("dds (i", n^2, ")"))) +
  geom_rug(data = varmt_es_z, aes(x = z.tmax_pAug), inherit.aes = FALSE,
           alpha = 0.1, sides = "b")
#nint5 <- plot_model(clim_int_es, type = "pred", terms = c("z.ppt_pJunSep","z.SLOPE"),
#                    axis.title = c("Precip","dds"), legend.title = "Slope", title = "")
nint4 <- plot_model(clim_nint_es, type = "pred", terms = c("z.ppt_pJunSep","z.BAL"),
                    axis.title = c("Precip","dds"), title = "f) BAL",  show.legend = F,
                    colors = c("grey72", "gray47", "gray0")) +
  theme_bw() + labs(y = expression(paste("dds (i", n^2, ")"))) +
  geom_rug(data = varmt_es_z, aes(x = z.ppt_pJunSep), inherit.aes = FALSE,
           alpha = 0.1, sides = "b")
all_int <- grid.arrange(clint,nint1,nint2,nint3,nint4,ncol = 2)
ggsave(filename = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/images/eff_int_es.png", all_int, scale = .5)

#presentation
temp_int <- plot_model(clim_n_es, type = "pred", terms = c("z.tmax_pAug","z.n_tmp"),
                    axis.title = c("Temperature","growth"),
                    colors = c("#3366FF", "#660099", "#CC0000")) +
  theme_bw()
ggsave(filename = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/images/temp_int.png", temp_int,
       width = 5, height = 4, units = "in")
prec_bal <- plot_model(clim_nint_es, type = "pred", terms = c("z.ppt_pJunSep","z.BAL"),
                    axis.title = c("Interannual Precipitation","dds"),,
                    colors = c("#3366FF", "#660099", "#CC0000")) +
  theme_bw()
ggsave(filename = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/images/prec_bal.png", prec_bal, 
       width = 5, height = 4, units = "in")
```

```{r}
plot_es <- list(es_mods,clint,nint1,nint2,nint3,nint4)
lay = rbind(c(1,1,2,3),
             c(1,1,4,5),
             c(1,1,6,7))
es_plot <- grid.arrange(grobs = plot_es, layout_matrix = lay)
ggsave(filename = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/images/es_coef.png", es_plot, 
...
clint_plt <- plot_int(data = varmt_es_z, term1 = "z.ppt_pJunSep", term2 =  "z.tmax_pAug", model = clim_red_es)
clint_plt <- clint_plt +
  labs(x = "Precip", title = "b) Temp") +
  theme(legend.position = "none")

nint1_plt <- plot_int(data = varmt_es_z, term1 = "z.ppt_pJunSep", term2 = "z.n_ppt", model = clim_n_es)
nint1_plt <- nint1_plt +
    labs(x = "Precip",  title = "c) Precip Normal") +
  theme(legend.position = "none")

nint2_plt <- plot_int(data = varmt_es_z, term1 = "z.ppt_pJunSep", term2 = "z.n_tmp", model = clim_n_es) 
nint2_plt <- nint2_plt +
    labs(x = "Precip",  title = "d) Temp Normal") +
  theme(legend.position = "none")

nint3_plt <- plot_int(data = varmt_es_z, term1 = "z.tmax_pAug", term2 = "z.n_tmp", model = clim_n_es) 
nint3_plt <- nint3_plt +
    labs(x = "Temp",  title = "e) Temp Normal") +
  theme(legend.position = "none")

nint4_plt <- plot_int(data = varmt_es_z, term1 = "z.ppt_pJunSep", term2 = "z.BAL", model = clim_nint_es) 
nint4_plt <- nint4_plt +
    labs(x = "Precip",  title = "f) BAL") +
  theme(legend.position = "none") 
...
plot_es <- list(pp_mods,clint_plt,nint1_plt,
...
```{r}
plot_model(clim_rs_es, type = "re")
```

```{r}
sample_tre <- sample(varmt_es_z$TRE_CN, size = 9)
pp1 <- ggpredict(clim_mod_es,
       terms=c("z.DIA_C","TRE_CN [sample_tre]"), type="random")
plot(pp1)
pp2 <- ggpredict(clim_rs_es,
       terms=c("z.DIA_C","TRE_CN [sample_tre]"), type="random")
plot(pp2)
```
