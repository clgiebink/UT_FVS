...
```{r }
load(file = '/home/giebink/Documents/Masters/UT/UT_FVS/data/formatted/data_all_pp.Rdata')
...
plot(effect("z.DIA_C",lmm_pp_red),xlab = "DBH",main = "DBH")
plot(effect("z.CR_weib",lmm_pp_red),xlab = "Crown Ratio",main = "Crown Ratio")
plot(effect("z.CCF",lmm_pp_red),xlab = "CCF",main = "CCF")
plot(effect("z.SICOND",lmm_pp_red),xlab = "Site Index",main = "Site Index")
plot(effect("z.SLOPE",lmm_pp_red),xlab = "Slope",main = "Slope")
plot(effect("z.wateryr",lmm_pp_red),xlab = "Precipitation",main = "Precipitation")
plot(effect("z.tmax_JunAug",lmm_pp_red),xlab = "Temperature",main = "Temperature")
```