...
A Variance Inflation Factor (VIF) above 3 shows strong collinearity; therefore, crown ratio (CR_weib) and basal area of trees larger than the subject tree (BAL) appear to be correlated. Slope and slope squared as well as crown competition factor of the subplot (PCCF) and the stand (CCF) seem to be mildly correlated.
