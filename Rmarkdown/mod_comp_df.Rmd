...
load data
```{r}
load(file = 'C:/Users/clgie/OneDrive/Documents/Masters/Utah/UT_FVS/data/formatted/glmm_df_z')
```
...
clim_1 <- lmer(log(dds)~z.SICOND+I(sin(z.ASPECT-0.7854)*z.SLOPE)+
                    ...
                    I(log(z.DIA_C))+I(z.BAL/100)+z.CR_weib+
                     I(z.DIA_C^2)+z.PCCF+I(z.CCF/100)+
                     z.ppt_pJunAug+z.tmax_FebJul+ #interaciton not significant
                     (1+z.DIA_C|TRE_CN)+(1|Year),
                   data = glmm_df_z)
clim_wy <- lmer(log(dds)~z.SICOND+I(sin(z.ASPECT-0.7854)*z.SLOPE)+
                    ...
                    I(log(z.DIA_C))+I(z.BAL/100)+z.CR_weib+
                     I(z.DIA_C^2)+z.PCCF+I(z.CCF/100)+
                     z.wateryr*z.tmax_FebJul+ #interaction significant
                     (1+z.DIA_C|TRE_CN)+(1|Year),
                   data = glmm_df_z)

#reduce based on significance
clim_1_red <- lmer(log(dds)~z.SICOND+
                       I(cos(z.ASPECT-0.7854)*z.SLOPE)+z.SLOPE+
                       I(log(z.DIA_C))+I(z.BAL/100)+z.CR_weib+
                       I(z.CCF/100)+
                     ...
                     data = glmm_df_z)
clim_wy_red <- lmer(log(dds)~z.SICOND+
                       I(cos(z.ASPECT-0.7854)*z.SLOPE)+z.SLOPE+
                       I(log(z.DIA_C))+I(z.BAL/100)+z.CR_weib+
                       I(z.CCF/100)+
