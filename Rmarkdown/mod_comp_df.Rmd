...
#TODO include graph of sin and cos of aspect?

```{r}
#reduce based on interpretability
#z.sin and z.cos
lmm_2_red <- lmer(log(dds)~
                 #tree variables
                 z.DIA_C+I(z.DIA_C^2)+ #remove log due to standardization
                 z.CR_weib+
                 #climate
