...
```{r}
ppt_norm <- read_csv(file = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/data/formatted/n_ppt_extr.csv")
tmp_norm <- read_csv(file = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/data/formatted/n_tmp_extr.csv")
tmx_norm <- read_csv(file = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/data/formatted/n_tmx_extr.csv")
```
...
```{r}
pred_fan_fmy$ppt.norm <- ppt_norm$normalspptNormals[match(pred_fan_fmy$TRE_CN,ppt_norm$TRE_CN)]
pred_fan_fmy$tmp.norm <- tmp_norm$normalstmpNormals[match(pred_fan_fmy$TRE_CN,tmp_norm$TRE_CN)]
pred_fan_fmy$tmx.norm <- tmx_norm$normalstmxNormals[match(pred_fan_fmy$TRE_CN,tmx_norm$TRE_CN)]
par(mfrow=c(2,2))
plot(pred_fan_fmy$ppt.norm,pred_fan_fmy$diff,
     xlab = "Mean Annual Precipitation", ylab = "Residuals")
plot(pred_fan_fmy$tmp.norm,pred_fan_fmy$diff,
     xlab = "Mean Annual Temperature", ylab = "Residuals")
plot(pred_fan_fmy$tmx.norm,pred_fan_fmy$diff,
     xlab = "Mean Annual Max Temperature", ylab = "Residuals")
```
...
```{r}
pred_an_fmy$ppt.norm <- ppt_norm$normalspptNormals[match(pred_an_fmy$TRE_CN,ppt_norm$TRE_CN)]
pred_an_fmy$tmp.norm <- tmp_norm$normalstmpNormals[match(pred_an_fmy$TRE_CN,tmp_norm$TRE_CN)]
pred_an_fmy$tmx.norm <- tmx_norm$normalstmxNormals[match(pred_an_fmy$TRE_CN,tmx_norm$TRE_CN)]
par(mfrow=c(2,2))
plot(pred_an_fmy$ppt.norm,pred_an_fmy$diff,
     xlab = "Mean Annual Precipitation", ylab = "Residuals")
plot(pred_an_fmy$tmp.norm,pred_an_fmy$diff,
     xlab = "Mean Annual Temperature", ylab = "Residuals")
plot(pred_an_fmy$tmx.norm,pred_an_fmy$diff,
     xlab = "Mean Annual Max Temperature", ylab = "Residuals")
```
...
```{r}
#save
save(pred_fan_cr,file = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/data/formatted/pred_fan_cr.Rdata")
save(pred_an_cr,file = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/data/formatted/pred_an_cr.Rdata")
save(pred_fclim_cr,file = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/data/formatted/pred_fclim_cr.Rdata")
save(pred_clim_cr,file = "/home/courtney/Documents/Masters/Research/Utah/UT_FVS/data/formatted/pred_clim_cr.Rdata")
```
...
```{r}
pred_fan_cr <- pred_fan_cr %>%
  group_by(TRE_CN) %>%
  mutate(DG_pred = max(DIA) - min(DIA),
         DG_obs = fDIA - min(DIA))
pred_fan_cr_fmy <- pred_fan_cr %>%
  filter(Year == fMEASYEAR)
# par(mfrow=c(1,2))
# plot(pred_fan_cr_fmy$DIA,pred_fan_cr_fmy$fDIA,
#      xlab = "Predicted", ylab = "Observed",
#      main = "DBH - Reduced: Tree-Rings + Climate")
# plot(pred_fan_cr_fmy$DG_pred,pred_fan_cr_fmy$DG_obs,
#      xlab = "Predicted", ylab = "Observed",
#      main = "DG - Reduced: Tree-Rings + Climate")
fit_fan_cr <- lm(fDIA~DIA,data = pred_fan_cr_fmy)
summary(fit_fan_cr )
sqrt(mean(fit_fan_cr $residuals^2))
# fit_fan_cr_dg <- lm(DG_obs~DG_pred,data = pred_fan_cr_fmy)
# summary(fit_fan_cr_dg)
# sqrt(mean(fit_fan_cr_dg$residuals^2))
```
...
#      xlab = "Predicted", ylab = "Observed",
#      main = "DG - Reduced: Tree-Rings + Climate")
fit_an_cr <- lm(fDIA~DIA,data = pred_an_cr_fmy)
summary(fit_an_cr )
sqrt(mean(fit_an_cr $residuals^2))
# fit_an_cr_dg <- lm(DG_obs~DG_pred,data = pred_an_cr_fmy)
# summary(fit_an_cr_dg)
# sqrt(mean(fit_an_cr_dg$residuals^2))
```

```{r}
pred_fclim_cr <- pred_fclim_cr %>%
  group_by(TRE_CN) %>%
  mutate(DG_pred = max(DIA) - min(DIA),
         DG_obs = fDIA - min(DIA))
pred_fclim_cr_fmy <- pred_fclim_cr %>%
  filter(Year == fMEASYEAR)
# par(mfrow=c(1,2))
# plot(pred_fan_cr_fmy$DIA,pred_fan_cr_fmy$fDIA,
#      xlab = "Predicted", ylab = "Observed",
...
#      xlab = "Predicted", ylab = "Observed",
#      main = "DG - Reduced: Tree-Rings + Climate")
fit_fclim_cr <- lm(fDIA~DIA,data = pred_fclim_cr_fmy)
summary(fit_fclim_cr )
sqrt(mean(fit_fclim_cr $residuals^2))
# fit_fan_cr_dg <- lm(DG_obs~DG_pred,data = pred_fan_cr_fmy)
# summary(fit_fan_cr_dg)
# sqrt(mean(fit_fan_cr_dg$residuals^2))
```
...
#      xlab = "Predicted", ylab = "Observed",
#      main = "DG - Reduced: Tree-Rings + Climate")
fit_clim_cr <- lm(fDIA~DIA,data = pred_clim_cr_fmy)
summary(fit_clim_cr )
sqrt(mean(fit_clim_cr $residuals^2))
# fit_an_cr_dg <- lm(DG_obs~DG_pred,data = pred_an_cr_fmy)
# summary(fit_an_cr_dg)
# sqrt(mean(fit_an_cr_dg$residuals^2))
```
